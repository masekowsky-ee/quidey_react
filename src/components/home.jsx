    ...
    return (
        <div className={styles.div}>
            ...
            <div className={styles.formsDiv}>
                <TaskForm showForms={showForms} setTasks={props.setTasks} t={props.t} setGroups={props.setGroups} taskIndexCounter={props.taskIndexCounter} setTaskIndexCounter={props.setTaskIndexCounter} />
            ...
            <TaskContainer setSessionParams={setSessionParams} tasks={props.tasks} groupToDisplayName={groupToDisplayName} setGroupToDisplayName={setGroupToDisplayName} setTasks={props.setTasks} t={props.t} groups={props.groups} setGroups={props.setGroups} setCustomError={setCustomError} />
            <Outlet />
        </div>
    );
}